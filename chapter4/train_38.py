...
def graph_plot(word_ten,count_ten):
    ...
    plt.title(u"出現頻度と単語種類のヒストグラム", fontdict = {"fontproperties": fp})
    plt.xlabel(u"出現頻度", fontdict = {"fontproperties": fp})
    plt.ylabel(u"単語種類数", fontdict = {"fontproperties": fp})
